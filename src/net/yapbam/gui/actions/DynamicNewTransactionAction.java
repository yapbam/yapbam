...
public class DynamicNewTransactionAction extends AbstractAction {
	private FilteredData data;
	
	public DynamicNewTransactionAction(FilteredData data) {
	...
	public void actionPerformed(ActionEvent e) {
		TransactionDialog.open(data, AbstractDialog.getOwnerWindow((Component) e.getSource()), null, false, true, getMassMode(e));
	}
