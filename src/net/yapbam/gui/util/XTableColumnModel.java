 ...
 *
 * @version 0.9 04/03/01 - modified version
 * @author Stephen Kelvin, mail@StephenKelvin.de (minor changes by Jean-Marc Astesana)
...
public class XTableColumnModel extends DefaultTableColumnModel {
	 ...
	 * <code>identifier</code>. Position is the index in all visible columns if
