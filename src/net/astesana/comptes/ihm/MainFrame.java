...
import net.astesana.comptes.data.event.*;
import net.astesana.comptes.ihm.graphics.balancehistory.BalanceHistoryPane;
import net.astesana.comptes.ihm.transactiontable.TransactionTable;
