...
public class DeferredValueDateComputer extends DateStepper {
	...
	public Date getNextStep(Date date) {
		if (DEBUG) {
			...
			System.out.println("  date d'arr�t de compte : "+this.stopDay);
			System.out.println("  date de d�bit : "+this.debtDay);
		}
		...
		gc.set(year, month, 1);
		if (DEBUG) System.out.println("  1 du mois du d�bit : "+DateFormat.getDateInstance().format(gc.getTime()));
		gc.add(GregorianCalendar.MONTH, 1);
		if (DEBUG) System.out.println("  1 du mois suivant  : "+DateFormat.getDateInstance().format(gc.getTime()));
		gc.add(GregorianCalendar.DAY_OF_MONTH, -1);
		if (DEBUG) System.out.println("  Dernier jour du mois du d�bit : "+DateFormat.getDateInstance().format(gc.getTime()));
		...
		if (DEBUG) System.out.println("Jour du d�bit : "+DateFormat.getDateInstance().format(gc.getTime()));
