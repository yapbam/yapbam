...
public class MainMenuBar extends JMenuBar implements ActionListener {
	...
	MainMenuBar (MainFrame frame) {
		...
		JMenuItem item = new JMenuItem(new NewTransactionAction(getTransactionSelector(), false));
		...
		item = new JMenuItem(new NewTransactionAction(getTransactionSelector(), true));
