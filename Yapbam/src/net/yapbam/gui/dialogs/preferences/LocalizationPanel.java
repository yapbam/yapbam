...
public class LocalizationPanel extends PreferencePanel {
	...
	private static final Locale[] LANGUAGES = new Locale[]{new Locale("ar"), Locale.GERMAN, Locale.ENGLISH, new Locale("es"), Locale.FRENCH, new Locale("pt"), new Locale("tr"), Locale.TRADITIONAL_CHINESE, new Locale("it"), new Locale("nl"), new Locale("pl"), new Locale("ru"), new Locale("hu"), new Locale("ja")}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
