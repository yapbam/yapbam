...
public class ObjectRenderer extends DefaultTableCellRenderer {
	...
	private static Color CASHIN = new Color(240,255,240);
	private static Color CASHOUT = new Color(255,240,240);
	...
	public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
	    ...
	    this.setHorizontalAlignment(model.getAlignment(column));
		if (isSelected) {
